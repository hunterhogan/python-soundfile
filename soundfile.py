...
from typing import Any, BinaryIO, Final, Optional, Union, overload
...
try:  # packaged lib (in _soundfile_data which should be on python path)
    ...
    _path: str = _os.path.dirname(_soundfile_data.__file__)  # TypeError if __file__ is None
    _full_path: str = _os.path.join(_path, _packaged_libname)
    _snd = _ffi.dlopen(_full_path)  # OSError if file doesn't exist or can't be loaded

except (OSError, ImportError, TypeError):
    try:  # system-wide libsndfile:
        _libname: Union[str, None] = _find_library('sndfile')
        if _libname is None:
...
__libsndfile_version__: str = _ffi.string(_snd.sf_version_string()).decode('utf-8', 'replace')
if __libsndfile_version__.startswith('libsndfile-'):
    __libsndfile_version__ = __libsndfile_version__[len('libsndfile-'):]


@overload
def read(file: FileDescriptorOrPath,
        frames: int = -1,
        start: int = 0,
        stop: Optional[int] = None,
        dtype: Literal['float64', 'float32', 'int32', 'int16'] = 'float64',
        always_2d: Literal[True] = True,
        fill_value: Optional[float] = None,
        out: Optional[numpy.ndarray[tuple[int, int], numpy.dtype[Union[numpy.floating[numpy._typing._32Bit], numpy.float64, numpy.int32, numpy.int16]]]] = None,
        ...
        closefd: bool = True
    ) -> tuple[numpy.ndarray[tuple[int, int], numpy.dtype[Union[numpy.floating[numpy._typing._32Bit], numpy.float64, numpy.int32, numpy.int16]]], int]:...
@overload
def read(file: FileDescriptorOrPath,
        frames: int = -1,
        start: int = 0,
        ...
        fill_value: Optional[float] = None,
        out: Optional[numpy.ndarray[tuple[int, ...], numpy.dtype[Union[numpy.floating[numpy._typing._32Bit], numpy.float64, numpy.int32, numpy.int16]]]] = None,
        samplerate: Optional[int] = None,
        channels: Optional[int] = None,
        format: Optional[str] = None,
        subtype: Optional[str] = None,
        endian: Optional[str] = None,
        closefd: bool = True
    ) -> tuple[numpy.ndarray[tuple[int, ...], numpy.dtype[Union[numpy.floating[numpy._typing._32Bit], numpy.float64, numpy.int32, numpy.int16]]], int]:...
def read(
...
class _SoundFileInfo:
    ...
    def __init__(self, file: FileDescriptorOrPath, verbose: bool = False) -> None:
        ...
        with SoundFile(file) as f:
            self.name: Union[str, int, Any] = f.name
    ...
    def _duration_str(self) -> str:
        ...
        if hours >= 1:
            duration: str = f"{hours:.0g}:{minutes:02.0g}:{seconds:05.3f} h"
        elif minutes >= 1:
...
class SoundFile:
    ...
    def __repr__(self) -> str:
        compression_setting: str = (f", compression_level={self.compression_level}"
    ...
    def read(self,
        ...
        fill_value: Optional[float] = None,
        out: Optional[numpy.ndarray[tuple[int, int], numpy.dtype[Union[numpy.floating[numpy._typing._32Bit], numpy.float64, numpy.int32, numpy.int16]]]] = None
    ) -> numpy.ndarray[tuple[int, int], numpy.dtype[Union[numpy.floating[numpy._typing._32Bit], numpy.float64, numpy.int32, numpy.int16]]]:...
    @overload
    def read(self,
        frames: int = -1,
        dtype: Literal['float64', 'float32', 'int32', 'int16'] = 'float64',
        ...
        fill_value: Optional[float] = None,
        out: Optional[numpy.ndarray[tuple[int, ...], numpy.dtype[Union[numpy.floating[numpy._typing._32Bit], numpy.float64, numpy.int32, numpy.int16]]]] = None
    ) -> numpy.ndarray[tuple[int, ...], numpy.dtype[Union[numpy.floating[numpy._typing._32Bit], numpy.float64, numpy.int32, numpy.int16]]]:...
    def read(self,
            frames: int = -1,
            dtype: str = 'float64',
            always_2d: bool = False,
    ...
    def buffer_read(self, frames: int = -1, dtype: Optional[str] = None) -> memoryview:
        ...
        ctype: str = self._check_dtype(dtype)
    ...
    def _init_virtual_io(self, file):
        ...
        self._virtual_io: dict[str, Union[Callable[..., Any], Callable[..., Union[Any, int]]]] = {'get_filelen': vio_get_filelen,
                            'seek': vio_seek,
                            'read': vio_read,
                            'write': vio_write,
                            'tell': vio_tell}
    ...
    def _create_empty_array(self, frames, always_2d, dtype) -> numpy.ndarray[tuple[int, ...], numpy.dtype[Union[numpy.floating[numpy._typing._32Bit], numpy.float64, numpy.int32, numpy.int16]]]:
    ...
    def _array_io(self, action: str, array: numpy.ndarray[tuple[int, ...], numpy.dtype[Union[numpy.floating[numpy._typing._32Bit], numpy.float64, numpy.int32, numpy.int16]]], frames: int) -> int:
    ...
    def _cdata_io(self, action: str, data, ctype: str, frames: int) -> int:
